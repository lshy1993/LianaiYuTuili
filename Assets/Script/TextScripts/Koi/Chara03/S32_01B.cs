...
{
    public class S32_01B : TextScript
    {
        public S32_01B(DataManager manager, GameObject root, PanelSwitch ps):base(manager, root, ps) { }
        public override void InitText()
        {
            ...
            pieces = new List<Piece>()
            {
                ...
                f.t("李云萧", "虽然知道了她的名字和住址，有种不好的预感，不会是假的吧？"),
                //——背景 消失——
            };
        }
