...
namespace Assets.Script.TextScripts
{
    ...
    {
        public T11009(Hashtable gVars, GameObject root, PanelSwitch ps):base(gVars, root, ps) { }
        public override void Init()
        {
            ...
            pieces = new List<Piece>()
            {
                ...
                //——背景 证人台侧——
                //——立绘 叶婷枫——
                f.t("【叶婷枫】", "这个，呀，不，我的确是听到了……"),
                f.t("【叶婷枫】", "啊！我想起来了，应该先讲这件事情。"),
                //——背景 法庭-审判长侧——
                //——立绘 审判长——
                ...
                //～看到了什么 2～
                //——BGM 询问变奏——
                f.t("【叶婷枫】", "响声之后，我立即朝办公室里面看去。"),
                f.t("【叶婷枫】", "我清楚地看到挂钟的指针指向12点15分。"),
                f.t("【叶婷枫】", "但是办公室里的挂钟，不可能慢了30分。"),
                f.t("【叶婷枫】", "所以，只有可能是我看到了镜子里的挂钟了。"),
                f.t("【叶婷枫】", "你看，办公室的一侧不是有很大一面镜子吗。"),
                f.t("【叶婷枫】", "我看到的时间，其实是反过来的，这样就没有问题了。"),
                //——证言完毕：背景变黑 BGM淡出——
                //——背景 法庭-审判长侧——
                //——立绘 审判长——
